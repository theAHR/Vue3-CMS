        ...
        <div class="dialog-body">
          <form @submit.prevent="handleSubmit">
            <div class="form-group">
              ...
              />
              <div v-if="errors.displayName" class="error-notification">
...
const validateForm = () => {
  ...
  if (!formData.value.displayName || !formData.value.displayName.trim()) {
    errors.value.displayName = 'عنوان الزامی است';
  } else if (formData.value.displayName.trim().length < 2) {
    errors.value.displayName = 'عنوان باید حداقل ۲ کاراکتر باشد';
  } else if (formData.value.displayName.trim().length > 200) {
    errors.value.displayName = 'عنوان نمی‌تواند بیشتر از ۲۰۰ کاراکتر باشد';
  }
